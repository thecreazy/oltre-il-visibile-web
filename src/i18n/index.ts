...
const dictionaries = {
  it: {
    ...
    home: {
      ...
      models_eyebrow: 'Volti',
      models_title: 'Volti che hanno scelto di essere raccontati',
    ...
    exhibitions: {
      ...
      models_involved: 'Volti presenti',
    ...
    seo: {
      ...
      models_title: 'Volti — Oltre il Visibile',
      models_desc: 'I volti e le esperienze dei partecipanti alla mostra e agli stage di Oltre il Visibile.',
  ...
  en: {
    ...
    home: {
      ...
      models_eyebrow: 'Faces',
      models_title: 'Faces that chose to be told',
    ...
    exhibitions: {
      ...
      models_involved: 'Faces featured',
    ...
    seo: {
      ...
      models_title: 'Faces — Oltre il Visibile',
      models_desc: 'The faces and experiences of participants in the Oltre il Visibile exhibition and workshops.',
