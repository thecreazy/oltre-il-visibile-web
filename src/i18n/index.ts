...
const dictionaries = {
  it: {
    ...
    press: {
      eyebrow: 'Stampa',
      title: 'Press',
      lead: 'Materiali per la stampa e contatti per richieste.',
      kit_title: 'Press kit',
      kit_text: 'Cartelle stampa, immagini ad alta risoluzione, biografie e crediti.',
      kit_contact: 'Contatto stampa',
      request: 'Richiedi materiali',
    },
    contact: {
      eyebrow: 'Contatti',
      title: 'Scrivici',
    ...
    seo: {
      ...
      press_desc: 'Materiali stampa e contatti per la mostra fine art nude itinerante.',
  ...
  en: {
    ...
    press: {
      eyebrow: 'Press',
      title: 'Press',
      lead: 'Materials for press and contacts for inquiries.',
      kit_title: 'Press kit',
      kit_text: 'Press packs, high-resolution images, biographies, credits.',
      kit_contact: 'Press contact',
    ...
    seo: {
      ...
      press_title: 'Press — Oltre il Visibile',
      press_desc: 'Press materials and contacts for the travelling fine art nude exhibition.',
